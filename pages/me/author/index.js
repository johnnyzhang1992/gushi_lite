...
Page({
  ...
  onLoad: function () {
    ...
    wx.request({
      url: 'https://xuegushi.cn/wxxcx/getCollect/'+this.data.user_id+'/author',
      success: res => {
        ...
        if (res.data) {
          that.setData({
            ...
            a_current_page:res.data.data.current_page,
            a_last_page:res.data.data.last_page,
    ...
    wx.request({
      ...
      success: res =>{
        if(res.data){
          ...
          // console.log(res.data);
          this.setData({
            poets: that.data.poets.concat(res.data.data.data),
            a_current_page:res.data.data.current_page,
            a_last_page:res.data.data.last_page,
          });
